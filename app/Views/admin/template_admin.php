...
<head>
    ...
    <link rel="stylesheet"
        href="/assets/adminlte3/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- overlayScrollbars -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <script>
                ...
                </script> <a href="/">Inipaket</a>.</strong> All rights reserved.
        </footer>
    ...
    <script>
    const flashDataLogin = $('.flash-data').data('flashdata');
    if (flashDataLogin) {
        Swal.fire(
            '',
            'login berhasil',
